...
#' Para mas informacion dobre esta funcion ir a \code{?seq_alignment}.
#' 
...
#' Laura Julia Melis.
#' 
#' Curs de Fonaments de Bioinformatica.
#' 
#' Master en Estadistica i Investigacio Operativa, Universitat de Barcelona.
#' 
#' @docType package
#' @name seqBio
NULL